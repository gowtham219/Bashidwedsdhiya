...
try {
  ...
  // Retry on first user interaction of any kind (covers all mobile browsers)
...
try {
  ...
  setInterval(spawnFloatItem, 3500);
  for(let i=0;i<3;i++) spawnFloatItem();
...
try {
  ...
  function showCelebration(){
    ...
    for(let i=0;i<10;i++) spawnFloatItem();
  }
